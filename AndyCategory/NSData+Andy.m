...
- (NSString *)andy_utf8String {
    if (self.length > 0) {
        return [[NSString alloc] initWithData:[self andy_UTF8Data] encoding:NSUTF8StringEncoding];
    }
    return @"";
}
...
+ (NSData *)andy_dataWithBase64EncodedString:(NSString *)base64EncodedString {
